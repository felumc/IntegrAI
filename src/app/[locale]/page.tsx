...
import t from '@/interfaces/Translation';
...
export default function Home() {
  ...
  const keys = ['faq.items.item1', 'faq.items.item2', 'faq.items.item3', 'faq.items.item4', 'faq.items.item5'] as const;
    ...
    <main className="min-h-screen bg-integrai-warm font-sans">
      ...
      <section id='services' className="pt-12 md:pt-32 pb-24 bg-white">
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row gap-16 items-start mb-20">
            ...
            <div className="flex-1">
              <h2 className="text-5xl md:text-7xl font-light text-[#0f172a] leading-tight mb-0">
                ...
                {t('services.heading.line2')}<br/>
                {t('services.heading.line3')}
              </h2>
            </div>
            {/* Right: Paragraphs and Link */}
            <div className="flex-1 flex flex-col justify-center">
              <p className="text-xl text-gray-900 mb-8 font-light">
                {t('services.description.p1')}
              </p>
              <p className="text-xl text-gray-900 mb-8 font-light">
                {t('services.description.p2')}
              </p>
          ...
          {/* Stats Row */}
          <h2 className="text-5xl md:text-6xl text-[#0f172a] mb-8 pt-24 text-center font-light border-t border-gray-200">{t('services.whatWeOffer')}</h2>
          
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 border-b pb-36 border-gray-200 pt-16">
            <div className="flex flex-col h-full">
              <div className="text-3xl md:text-5xl font-light text-[#0f172a] mb-12 pl-8 md:pl-0">{t('services.offerings.automation.title')}</div>
              <div className="flex-grow" />
              <div className="text-lg text-gray-600 font-light mb-0 pl-8 md:pl-0">{t('services.offerings.automation.description')}</div>
            </div>
            <div className="flex flex-col h-full border-l border-gray-200 pl-8">
              <div className="text-3xl md:text-5xl font-light text-[#0f172a] mb-12">{t('services.offerings.assistants.title')}</div>
              <div className="flex-grow" />
              <div className="text-lg text-gray-600 font-light mb-0">{t('services.offerings.assistants.description')}</div>
            </div>
            <div className="flex flex-col h-full border-l border-gray-200 pl-8">
              <div className="text-3xl md:text-5xl font-light text-[#0f172a] mb-12">{t('services.offerings.integration.title')}</div>
              <div className="flex-grow" />
              <div className="text-lg text-gray-600 font-light mb-0">{t('services.offerings.integration.description')}</div>
            </div>
            <div className="flex flex-col h-full border-l border-gray-200 pl-8">
              <div className="text-3xl md:text-5xl font-light text-[#0f172a] mb-12">{t('services.offerings.strategy.title')}</div>
              <div className="flex-grow" />
              <div className="text-lg text-gray-600 font-light mb-0">{t('services.offerings.strategy.description')}</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="pb-32 bg-white">
        <div className="container mx-auto px-4">
          <h2 className="text-5xl md:text-7xl text-[#0f172a] mb-8 text-center font-light">{t('process.title')}</h2>
          <p className="text-2xl font-light text-[#0f172a] mb-20 text-center">{t('process.subtitle')}</p>
      ...
      <section className="py-32 bg-black">
        <div className="container mx-auto px-4">
          <div className="flex flex-col items-center mb-8">
            <h2 className="text-7xl font-light text-center mb-2 text-white">{t('benefits.title.line1')}</h2>
            <h2 className="text-7xl font-light text-center mb-8 text-white">{t('benefits.title.line2')}</h2>
          ...
          <div className="grid md:grid-cols-3 gap-10 max-w-7xl mx-auto">
            <div className="bg-[#18181b] border border-gray-800 rounded-3xl p-10 shadow-lg hover:bg-[#23232a] transition-all relative overflow-hidden">
              ...
              <h3 className="text-4xl font-light mb-12 text-white">{t('benefits.items.productivity.title')}</h3>
              <div className="flex-grow" />
              <p className="text-gray-300 font-light text-lg">{t('benefits.items.productivity.description')}</p>
            </div>
            <div className="bg-[#18181b] border border-gray-800 rounded-3xl p-10 shadow-lg hover:bg-[#23232a] transition-all relative overflow-hidden">
              <FiSmile className="text-white text-3xl mb-6" />
              <h3 className="text-4xl font-light mb-12 text-white">{t('benefits.items.customerExperience.title')}</h3>
              <div className="flex-grow" />
              <p className="text-gray-300 font-light text-lg">{t('benefits.items.customerExperience.description')}</p>
            </div>
            <div className="bg-[#18181b] border border-gray-800 rounded-3xl p-10 shadow-lg hover:bg-[#23232a] transition-all relative overflow-hidden">
              <FiClock className="text-white text-3xl mb-6" />
              <h3 className="text-4xl font-light mb-12 text-white">{t('benefits.items.availability.title')}</h3>
              <div className="flex-grow" />
              <p className="text-gray-300 font-light text-lg">{t('benefits.items.availability.description')}</p>
            </div>
            <div className="bg-[#18181b] border border-gray-800 rounded-3xl p-10 shadow-lg hover:bg-[#23232a] transition-all relative overflow-hidden">
              <FiDollarSign className="text-white text-3xl mb-6" />
              <h3 className="text-4xl font-light mb-12 text-white">{t('benefits.items.costReduction.title')}</h3>
              <div className="flex-grow" />
              <p className="text-gray-300 font-light text-lg">{t('benefits.items.costReduction.description')}</p>
            </div>
            <div className="bg-[#18181b] border border-gray-800 rounded-3xl p-10 shadow-lg hover:bg-[#23232a] transition-all relative overflow-hidden">
              <FiBarChart2 className="text-white text-3xl mb-6" />
              <h3 className="text-4xl font-light mb-12 text-white">{t('benefits.items.insights.title')}</h3>
              <div className="flex-grow" />
              <p className="text-gray-300 font-light text-lg">{t('benefits.items.insights.description')}</p>
            </div>
            <div className="bg-[#18181b] border border-gray-800 rounded-3xl p-10 shadow-lg hover:bg-[#23232a] transition-all relative overflow-hidden">
              <FiTrendingUp className="text-white text-3xl mb-6" />
              <h3 className="text-4xl font-light mb-12 text-white">{t('benefits.items.scalability.title')}</h3>
              <div className="flex-grow" />
              <p className="text-gray-300 font-light text-lg">{t('benefits.items.scalability.description')}</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row gap-16 items-start">
            ...
            <div className="flex-1 mb-12 md:mb-0">
              <h2 className="text-6xl md:text-7xl font-light text-[#0f172a] leading-tight mb-6">{t('faq.title')}</h2>
              <p className="text-xl text-gray-500 font-light">{t('faq.subtitle')}</p>
            </div>
            {/* Right: FAQ Accordion */}
            <div className="flex-1 w-full max-w-xl mx-auto divide-y divide-gray-200">
              {keys.map((faq, idx) => {
                ...
                return isOpen ? (
                  <div key={t(`${faq}.question`)} className="rounded-2xl bg-gray-100 px-4 pt-8 pb-6 mb-2">
                    <button
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row gap-16 mb-12">
            ...
            <div className="flex-[2] flex flex-col items-start">
              <h2 className="text-7xl font-light mb-2 text-white">{t('cta.title.line1')}</h2>
              <h2 className="text-7xl font-light mb-8 text-white">{t('cta.title.line2')}</h2>
              <p className="text-2xl font-light text-white mb-12">{t('cta.subtitle')}</p>
              <a
                href="#"
                onClick={e => {
                  e.preventDefault();
            ...
            <div className="flex-1 flex flex-col justify-center items-center bg-white/10 rounded-3xl p-10 shadow-lg backdrop-blur-md mb-12">
              <form className="w-full max-w-md space-y-4">
                <div>
                  <label htmlFor="name" className="block text-white text-lg font-light mb-2">{t('cta.form.name')}</label>
                ...
                <div>
                  <label htmlFor="email" className="block text-white text-lg font-light mb-2">{t('cta.form.email')}</label>
                ...
                <div>
                  <label htmlFor="message" className="block text-white text-lg font-light mb-2">{t('cta.form.message')}</label>
                ...
                <button type="submit" className="w-full bg-white text-[#0f172a] py-4 rounded-2xl font-normal text-lg shadow-md hover:bg-blue-100 transition-all border-2 border-white">{t('cta.form.button')}</button>
              </form>
            </div>
          </div>
