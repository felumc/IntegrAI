  ...
  return (
    <main className="min-h-screen bg-integrai-warm font-sans">
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row gap-16 items-start mb-20">
            ...
            <div className="flex-1">
              <h2 className="text-6xl md:text-7xl font-light text-[#0f172a] leading-tight mb-0">
          ...
          {/* Stats Row */}
          <h2 className="text-6xl text-[#0f172a] mb-8 pt-24 text-center font-light border-t border-gray-200">{translations.services.whatWeOffer}</h2>
          
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 border-b pb-36 border-gray-200 pt-16">
            <div className="flex flex-col h-full">
              <div className="text-3xl md:text-5xl font-light text-[#0f172a] mb-12">{translations.services.offerings.automation.title}</div>
              <div className="flex-grow" />
              <div className="text-lg text-gray-600 font-light mb-0">{translations.services.offerings.automation.description}</div>
            </div>
      ...
      <section className="pb-32 bg-white">
        <div className="container mx-auto px-4">
          <h2 className="text-7xl text-[#0f172a] mb-8 text-center font-light">{translations.process.title}</h2>
